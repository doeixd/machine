...
exports.BoundMachine = void 0;
exports.isState = isState;
exports.createEvent = createEvent;
exports.mergeContext = mergeContext;
exports.pipeTransitions = pipeTransitions;
exports.logState = logState;
exports.createTransition = createTransition;
exports.call = call;
exports.bindTransitions = bindTransitions;
exports.sequence = sequence;
exports.sequence2 = sequence2;
exports.sequence3 = sequence3;
const index_1 = require("./index"); // Assuming index.ts is in the same directory
/**
...
function mergeContext(machine, partialContext) {
    return (0, index_1.setContext)(machine, (ctx) => ({ ...ctx, ...partialContext }));
}
// =============================================================================
...
function createTransition(getTransitions, transformer) {
    return function (...args) {
        ...
        return (0, index_1.createMachine)(nextContext, getTransitions());
    };
}
// =============================================================================
...
exports.BoundMachine = BoundMachine;
/**
...
function createSequenceMachine(machines, isFinal) {
    ...
    const createDelegationObject = (machine) => {
        ...
        const methodNames = Object.getOwnPropertyNames(originalProto).filter(name => name !== 'constructor' && name !== 'context' && typeof machine[name] === 'function');
        for (const methodName of methodNames) {
            const methodKey = methodName;
            delegationObject[methodKey] = (...args) => {
                const result = currentMachine[methodKey](...args);
                // Handle both sync and async results
                const handleResult = (resultMachine) => {
                    return advanceIfNeeded(resultMachine);
                };
 ...
 */
function sequence(machines, isFinal) {
 ...
 * ```
 */
function sequence2(machine1, machine2, isFinal) {
 ...
 * ```
 */
function sequence3(machine1, machine2, machine3, isFinal) {
